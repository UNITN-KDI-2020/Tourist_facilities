    ...
    def parse (self, response):
        ...
        for resort in ski_items:
            ...
            yield {
                ...
                'name': name,
                'Total lenght': resort.css('span.slopeinfoitem::text').getall()[0],
                'km blue slope': resort.css('span.slopeinfoitem::text').getall()[1],
                'km red slope': resort.css('span.slopeinfoitem::text').getall()[2],
                'km black slope': resort.css('span.slopeinfoitem::text').getall()[3],
                'lifts': resort.css('li::text').getall()[0],
                'price': resort.css('td::text').getall()[len(resort.css('td::text').getall()) - 1].replace("\u20ac","")
            }
